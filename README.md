...
**no source code** — Karja is proprietary software. The installers here are
published automatically from the private development repository.
...
Karja is proprietary software. Your use of the Software is governed by the
[End-User License Agreement](LICENSE). The Software also includes third-party
open-source components, each under its own license.

© Himangshu Saikia. All rights reserved.
